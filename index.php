...
<header id="home-grid">
    <div id="header-grid-shade">    
        <div id="header-grid-item">
            <h1><a href="#about-grid"><img src="img/logo.svg" alt="A" id="logo1"></a> LI SH <a href="#contact-grid"><img src="img/logo.svg" alt="A" id="logo2"></a> RIATI</h1>
...
<section class="container-grid">
    <div id="contact-grid">
        <div id="contact-grid-item-1"><h4>CONT<a href="#home-grid"><img src="img/logo.svg" alt="A" id="logo3"></a>CT</h4></div>
