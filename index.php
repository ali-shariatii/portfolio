...
<head>
    ...
    <meta name="description" content="I am a web designer & developer with an interest and passion in building web applications and websites. My main focus is mostly on front-end side including advanced CSS + extension, JavaScript & JS libraries/frameworks and building interactive & responsive web flows.">
...
<div id="nav-grid" class="hidden-fixed-nav shadow-filter-effect">
    <div id="nav-item-1">
        <audio id="clickSnd" src="snd/click.mp3"></audio>
        <audio id="clickSnd2" src="snd/click2.mp3"></audio>
        <audio id="bgMusic" src="snd/bg-music.mp3" loop></audio>
        <div id="ctrl-container" >
            <div id="musicBtn" onclick="toggleMusic();"></div>
            <div id="musicBtnMin" onclick="toggleMusic();"></div>
        </div>
    </div>
    <div id="nav-item-2">
        <ul>
            <li onclick="clickEffect2();"><div><a href="#home-grid" id="home-tab" class="active-tab">HOME</a></div></li>
            <li onclick="clickEffect2();"><div><a href="#about-grid" id="about-tab">ABOUT</a></div></li> 
            <li onclick="clickEffect2();"><div><a href="#work-grid" id="work-tab">WORK</a></div></li> 
            <li onclick="clickEffect2();"><div><a href="#testimonials-grid" id="testimonials-tab">TESTIMONIALS</a></div></li> 
            <li onclick="clickEffect2();"><div><a href="#contact-grid" id="contact-tab">CONTACT</a></div></li> 
        </ul>
    </div>
    <div id="nav-item-3">
        <div id="nav-github"><a href="https://github.com/ali-shariatii/" target="_blank" class="fa fa-github" id="nav-github"></a></div>
        <!-- hamburger icon-->
        <div id="hamburger-menu-container" class="align-container-1"><div id="hamburgerIcon" class="hamburger"></div></div>
    </div>
    <!-- dropdown menu-->
    <div id="nav-item-4" class="hidden-dropdown">
        <div id=menu-min>
            <ul>
                <li onclick="clickEffect2();"><div><a href="#home-grid" id="home-tab-min" >HOME</a></div></li><br>
                <li onclick="clickEffect2();"><div><a href="#about-grid" id="about-tab-min">ABOUT</a></div></li><br> 
                <li onclick="clickEffect2();"><div><a href="#work-grid" id="work-tab-min">WORK</a></div></li><br> 
                <li onclick="clickEffect2();"><div><a href="#testimonials-grid" id="testimonials-tab-min">TESTIMONIALS</a></div></li><br> 
                <li onclick="clickEffect2();"><div><a href="#contact-grid" id="contact-tab-min">CONTACT</a></div></li> 
            </ul>
        </div>
        <div id="social-media-min">
            <ul>
                <li><a href="mailto:info@alishariatii.com" class="fa fa-envelope"></a> 
                <li><a href="https://github.com/ali-shariatii/" target="_blank" class="fa fa-github"></a></li>
                <li><a href="https://www.linkedin.com/in/ali-shariatii/" target="_blank" class="fa fa-linkedin"></a></li>
                <li><a href="https://stackoverflow.com/users/13517523/ali-shariati" target="_blank" class="fa fa-stack-overflow"></a></li></li>
            </ul>
        </div>
    </div>
</div>
...
<div id="media-container">
    <div id="media-window">
        <ul>
            <li><a href="mailto:info@alishariatii.com" class="fa fa-envelope"></a></li>
            <li><a href="https://github.com/ali-shariatii/" target="_blank" class="fa fa-github"></a></li>
            <li><a href="https://www.linkedin.com/in/ali-shariatii/" target="_blank" class="fa fa-linkedin"></a></li>
            <li><a href="https://stackoverflow.com/users/13517523/ali-shariati" target="_blank" class="fa fa-stack-overflow"></a></li>
        </ul>
    </div>
...
<header id="home-grid">
    <div id="header-grid-shade">    
        <div id="header-grid-item">
            <h1><a href="#about-grid" class="header-logo-position logoPointer" onclick="clickEffect2();"><img src="img/logo.svg" alt="A" id="logo1"></a><div class="name-letters">LI SH</div><a href="#contact-grid" class="header-logo-position logoPointer" onclick="clickEffect2();"><img src="img/logo.svg" alt="A" id="logo2"></a><div class="name-letters">RIATI</div></h1>
            <h3>WEB DEVELOPER | WEB DESIGNER</h3>
        </div>
    </div>
    <img src="img/sky-city-1.png" alt="sky-city" class="sky-city-1" id="sky-city-1">
    <img src="img/sky-city-1-1200px.png" alt="sky-city" class="sky-city-1" id="sky-city-1-1200px">
    <img src="img/sky-city-1-992px.png" alt="sky-city" class="sky-city-1" id="sky-city-1-992px">
    <img src="img/sky-city-1-768px.png" alt="sky-city" class="sky-city-1" id="sky-city-1-768px">
    <img src="img/sky-city-1-600px.png" alt="sky-city" class="sky-city-1" id="sky-city-1-600px">
    <img src="img/sky-city-1-400px.png" alt="sky-city" class="sky-city-1" id="sky-city-1-400px">
</header>
...
<section class="container-grid" id="about-container">
    <div id="about-grid">
        ...
        <div id="about-grid-item-3">
            <p class="init-appear-in">I am a web designer & developer with an interest and passion in building web applications and websites. My main focus is mostly on front-end side including advanced CSS + extension, JavaScript & JS libraries/frameworks and building interactive & responsive web flows. My quote of the month is__<q>Work hard,<a href="https://github.com/ali-shariatii/" target="_blank" title="More Code on Github"> code hardcore</a>.</q></p>
        </div>
        ...
        <div id="work-grid-item-3">
            <div id="gallery-grid-item-1" class="init-scale-in">
                ...
                <div class="work-img-container" id="modalOpener1">
                    ...
                    <img src="img/i2canada-thumbnail-wide.jpg" alt="i2canada" onclick="clickEffect2();">
                    <span onclick="clickEffect2();">HTML | CSS | JAVASCRIPT</span>
                </div>
            </div>
            ...
            <div id="gallery-grid-item-2" class="init-scale-in">
                ...
                <div class="work-img-container" id="modalOpener2">
                    <div class="info-alert">More Info</div>
                    <img src="img/shiftdo-thumbnail-wide.jpg" alt="Shiftdo" onclick="clickEffect2();">
                    <span onclick="clickEffect2();">HTML | CSS | WORDPRESS</span>
                </div>
            </div>
    ...
    <div id="testimonials-grid">
        <!--<div id="testimonials-grid-shade">-->
            ...
            <div id="testimonials-grid-item-2">
                <div id="recom-item-1" class="init-scale-in"><p><q>Ali is a team player & an exceptional problem solver.</q></p></div>
                <div id="recom-item-2" class="init-scale-in"><p><q>He is keen to learn new skills & challenge himself every day.</q></p></div>
                <div id="recom-item-3" class="init-scale-in"><p><q>Every team which Ali is a part of, is among the winners.</q></p></div>
                <div id="recom-item-4" class="init-appear-in"><p><a href="https://www.linkedin.com/in/ali-shariatii/" target="_blank"><span>More on </span></a><a href="https://www.linkedin.com/in/ali-shariatii/"target="_blank" class="fa fa-linkedin" id="in"></a></p></div>
            </div>
        <!--</div>-->
    </div>
</section>
...
<section class="container-grid" id="contact-container">
    <div id="contact-grid">
        <div id="contact-grid-item-1"><h4>CONT<a href="#home-grid" class="logoPointer" onclick="clickEffect2();"><img src="img/logo.svg" alt="A"id="logo3"></a>CT</h4></div>
        <div id="contact-grid-item-2" class="init-scale-in">
            <form id="form-grid" action="contactform.php" method="POST">
                ...
                <div id="form-grid-item-6"><button type="submit" name="submit"  onclick="clickEffect2();">SUBMIT</button></div>
            </form>
        </div>
    </div>
